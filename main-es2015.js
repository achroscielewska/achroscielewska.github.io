...
let AppModule = class AppModule {
    constructor(injector, storage, userService) {
        this.injector = injector;
        this.storage = storage;
        this.userService = userService;
        const simulationModule = Object(_angular_elements__WEBPACK_IMPORTED_MODULE_8__["createCustomElement"])(_app_modules_simulation_components_simulation_base_simulation_base_component__WEBPACK_IMPORTED_MODULE_10__["SimulationBaseComponent"], { injector });
        const contactModule = Object(_angular_elements__WEBPACK_IMPORTED_MODULE_8__["createCustomElement"])(_modules_contact_components__WEBPACK_IMPORTED_MODULE_14__["ContactBaseComponent"], { injector });
        const checklistModule = Object(_angular_elements__WEBPACK_IMPORTED_MODULE_8__["createCustomElement"])(_app_modules_checklist_components_checklist_base_checklist_base_component__WEBPACK_IMPORTED_MODULE_12__["ChecklistBaseComponent"], { injector });
        const loginModule = Object(_angular_elements__WEBPACK_IMPORTED_MODULE_8__["createCustomElement"])(_app_modules_login_login_home_login_home_component__WEBPACK_IMPORTED_MODULE_15__["LoginHomeComponent"], { injector });
...
let ChecklistRoutingModule = class ChecklistRoutingModule {
};
...
let ChecklistBaseComponent = class ChecklistBaseComponent {
    constructor(router, eltRef, interComponentCommunicationService, userService) {
        this.router = router;
        this.eltRef = eltRef;
    ...
    ngOnInit() {
        ...
        setTimeout(() => {
            this.router.navigate([{ outlets: { checklist: ['dokumenty'] } }], { skipLocationChange: true });
        }, 200);
        const showSimulationBtn = this.eltRef.nativeElement.hasAttribute('simulationAnchor');
        if (showSimulationBtn) {
            const simulationAnchor = this.eltRef.nativeElement.getAttribute('simulationAnchor');
            this.interComponentCommunicationService.showSimulationBtn(simulationAnchor);
        }
        const hasViewportScrollAnchor = this.eltRef.nativeElement.hasAttribute('viewportScrollAnchor');
        if (hasViewportScrollAnchor) {
            const viewportScrollAnchor = this.eltRef.nativeElement.getAttribute('viewportScrollAnchor');
            this.interComponentCommunicationService.setViewportScrollAnchor(viewportScrollAnchor);
        }
    }
};
ChecklistBaseComponent.ctorParameters = () => [
...
let ChecklistHomeComponent = class ChecklistHomeComponent {
    constructor(translate, translationLoader, interComponentCommunicationService) {
...
ChecklistHomeComponent.ctorParameters = () => [
...
let ChecklistPathComponent = class ChecklistPathComponent {
    constructor(translate, translationLoader, validationsLoader, router, route, checklistService, viewportScroller, checklistModelConfigurationService, interComponentCommunicationService) {
        this.translate = translate;
        this.translationLoader = translationLoader;
    ...
    ngOnInit() {
        ...
        const stepOneFields = this.checklistModelConfigurationService.formFieldStepOne();
    ...
    onInit(stepOneFields) {
        this.formSteps = [
            stepOneFields,
            this.checklistModelConfigurationService.formFieldStepTwo(),
            this.checklistModelConfigurationService.formFieldStepThree()
        ];
        this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormArray"](this.formSteps.map(() => new _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormGroup"]({})));
    ...
    submit(step) {
        if (this.form.valid) {
            ...
            this.checklistService.fetchDocuments(this.model.CheckListData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["map"])((result) => {
                _app_modules_shared_module_components_loader_loader_component__WEBPACK_IMPORTED_MODULE_9__["LoaderComponent"].hide();
                this.methodUnavailable = false;
                this.checklistService.updateChecklistResult(result);
                this.interComponentChecklistCommunicationService.setUpSimulationStep(step + 1);
                this.interComponentChecklistCommunicationService.setIsChecklistResultView(true);
...
ChecklistPathComponent.ctorParameters = () => [
    { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"] },
    { type: _app_modules_shared_module_services_i18n_translation_loader_service__WEBPACK_IMPORTED_MODULE_3__["TranslationLoaderService"] },
...
let ChecklistResultsComponent = class ChecklistResultsComponent {
    constructor(translate, translationLoader, validationsLoader, checklistService, viewportScroller, checklistModelConfigurationService, router, route, interComponentCommunicationService) {
        this.translate = translate;
        this.translationLoader = translationLoader;
        this.validationsLoader = validationsLoader;
        this.checklistService = checklistService;
        ...
        this.translationLoader.loadTranslations();
        this.validationsLoader.init();
        this.translate.get('SimulatorResults').subscribe(translated => {
    ...
    ngOnInit() {
        this.viewportScrollAnchor = this.interComponentCommunicationService.viewportScrollAnchor;
        const result = this.checklistService.getCheckListResults();
        this.checklistResult = result;
        for (let i = 0; i < result.documents.sections.length; i++) {
            this.sections[i].subsections = result.documents.sections[i].entries;
            this.sections[i].subsections.forEach(subsection => {
                subsection.visible = false;
            });
        }
    }
    toggle(sectionIndex, subSectionIndex) {
    ...
    goBack() {
        ...
        this.interComponentCommunicationService.setIsChecklistResultView(false);
        this.interComponentCommunicationService.setUpSimulationStep(0);
        this.router.navigate(['../start'], { relativeTo: this.route, skipLocationChange: true }).catch(error => {
            console.log(error);
        });
    }
};
ChecklistResultsComponent.ctorParameters = () => [
    { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"] },
    { type: _app_modules_shared_module_services_i18n_translation_loader_service__WEBPACK_IMPORTED_MODULE_3__["TranslationLoaderService"] },
...
let ChecklistSendComponent = class ChecklistSendComponent {
    constructor(translate, translationLoader, validationsLoader, checklistService, router, route, viewportScroller, interComponentCommunicationService, storage, userService) {
        this.translate = translate;
        this.translationLoader = translationLoader;
        this.validationsLoader = validationsLoader;
        this.checklistService = checklistService;
    ...
    saveLeadAndCheckListAndSendEmail() {
        this.checklistService.saveLead(this.model).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["flatMap"])(saveLeadResult => {
            this.storage.set('leadId', saveLeadResult.id);
            return this.checklistService.saveChecklist(saveLeadResult.id);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["flatMap"])(() => {
            return this.checklistService.sendChecklist(this.model.email);
            ...
            this.router.navigate(['../dziekujemy'], { relativeTo: this.route, skipLocationChange: true });
    ...
    sendEmail() {
        this.checklistService.sendChecklist(this.model.email).subscribe(value => {
            _app_modules_shared_module_components_loader_loader_component__WEBPACK_IMPORTED_MODULE_6__["LoaderComponent"].hide();
            this.router.navigate(['../dziekujemy'], { relativeTo: this.route, skipLocationChange: true });
        }, err => {
            console.log(err);
...
ChecklistSendComponent.ctorParameters = () => [
...
let ChecklistSentComponent = class ChecklistSentComponent {
    constructor(translate, translationLoader, validationsLoader, viewportScroller, eltRef, interComponentCommunicationService, router, route) {
        this.translate = translate;
        this.translationLoader = translationLoader;
        this.validationsLoader = validationsLoader;
        this.viewportScroller = viewportScroller;
        ...
        this.translationLoader.loadTranslations();
        this.validationsLoader.init();
        this.translate.get('ChecklistResults').subscribe(translated => {
            this.translations = translated;
        });
    }
    ngOnInit() {
    ...
    goToChecklistStartPage() {
        this.router.navigate(['../'], { relativeTo: this.route, skipLocationChange: true });
    }
};
ChecklistSentComponent.ctorParameters = () => [
    { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"] },
    { type: _app_modules_shared_module_services_i18n_translation_loader_service__WEBPACK_IMPORTED_MODULE_3__["TranslationLoaderService"] },
    { type: _app_modules_shared_module_services_i18n_validations_loader__WEBPACK_IMPORTED_MODULE_4__["ValidationLoader"] },
...
class CheckListData {
    constructor(loanAmount = null, creditPurposes = [new CreditPurpose()], applicants = [new Applicant()], email = '') {
...
class CreditPurpose {
    constructor(creditPurpose = '', flatPurchaseType, housePurchaseType, propertyState, refinancingPurpose, refinancingType) {
...
class Applicant {
    constructor(maritalStatus = '', regimeOfSeparateProperty, incomes = [new ApplicantIncome()]) {
...
class ApplicantIncome {
    constructor(incomeType = '', employmentContractType, employmentIncomeTypeBankAccount, employmentIncomeTypePremium, employmentIncomeTypeInternationalIncome, b2bContractType, b2bContractBillingType, farmIncomeTypeSpecialBranches, farmIncomeTypeRecordKeeping, farmIncomeTypeTenancy, otherIncomeTypePension, otherIncomeTypeAnnuity, otherIncomeTypeSeafarer, otherIncomeTypeRentalAgreement, otherIncomeType500plus, otherIncomeTypeSupervisoryBoardMember) {
...
class ChecklistGenerationRequest {
}
...
let ChecklistControlService = class ChecklistControlService {
    ...
    makeChecklistRequest$(request) {
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].checklist.isMock) {
            ...
            return this.httpClient.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].checklist.url, request, { headers });
        }
    }
    sendMail$(checklists) {
        const headers = this.prepareHeaders();
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].checklist.isMock) {
            ...
            return this.httpClient.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].checklist.emailUrl, checklists, { headers });
        }
    }
    saveChecklist$(checklist) {
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].checklist.isMock) {
            ...
            return this.httpClient.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].checklist.saveUrl, checklist, { headers });
        }
    }
};
ChecklistControlService.ctorParameters = () => [
...
let ChecklistFormConfigurationService = class ChecklistFormConfigurationService {
                            ...
                            fieldGroup: [
                                ...
                                },
                                {
                                    ...
                                    hideExpression: ($viewValue, $modelValue, scope) => {
                                        const hide = $viewValue.maritalStatus !== 'married';
                                        if (hide) {
                                    ...
                                    fieldArray: {
                                        fieldGroup: [
                                            ...
                                            },
                                            {
                                                ...
                                                hideExpression: ($viewValue, $modelValue, scope) => {
                                                    const hide = $viewValue.incomeType !== 'employmentContract';
                                                    if (hide) {
                                            ...
                                            },
                                            {
                                                ...
                                                hideExpression: ($viewValue, $modelValue, scope) => {
                                                    const hide = $viewValue.incomeType !== 'B2B';
                                                    if (hide) {
                                            ...
                                            },
                                            {
                                                className: 'app-checkbox-group-list',
                                                hideExpression: ($viewValue, $modelValue, scope) => {
                                                    const hide = $viewValue.incomeType !== 'farmIncome';
                                                    if (hide) {
                                            ...
                                            },
                                            {
                                                className: 'app-checkbox-group-list',
                                                hideExpression: ($viewValue, $modelValue, scope) => {
                                                    const hide = $viewValue.incomeType !== 'otherIncome';
                                                    if (hide) {
    ...
    formFlatPurchaseType() {
        return {
            ...
            hideExpression: ($viewValue, $modelValue, scope) => {
                const hide = $viewValue.creditPurpose !== 'flat';
                if (hide) {
    ...
    formHousePurchaseType() {
        return {
            ...
            hideExpression: ($viewValue, $modelValue, scope) => {
                const hide = $viewValue.creditPurpose !== 'house';
                if (hide) {
    ...
    formPropertyState() {
        return {
            ...
            hideExpression: ($viewValue, $modelValue, scope) => {
                const hide = $viewValue.flatPurchaseType !== 'developer' && $viewValue.housePurchaseType !== 'developer';
                if (hide) {
    ...
    formRefinancingType() {
        return {
            ...
            hideExpression: ($viewValue, $modelValue, scope) => {
                const hide = $viewValue.creditPurpose !== 'refinancing';
                if (hide) {
...
ChecklistFormConfigurationService.ctorParameters = () => [
    { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"] }
];
...
let ChecklistService = class ChecklistService {
    constructor(checklistControlService, contactService) {
        ...
        this.currentChecklistResult.documents.sections.forEach(section => {
            section.entries.forEach(sectionEntry => {
                ...
                if (section.code === 'requesters') {
                    applicants.push({ documents });
                }
                if (section.code === 'requestPurposes') {
                    creditPurposes.push({ documents });
                }
            });
        });
    ...
    deepCopy(target) {
        ...
        if (target instanceof Array) {
            ...
            return cp.map((n) => this.deepCopy(n));
        }
...
let InterComponentCommunicationService = class InterComponentCommunicationService {
    constructor() {
    ...
    showSimulationBtn(simulationAnchor) {
        this.isSimulationBtnVisible = true;
        this.simulationAnchor = simulationAnchor;
    }
    setViewportScrollAnchor(viewportScrollAnchor) {
        this.viewportScrollAnchor = viewportScrollAnchor;
    }
    setUpSimulationStep(stepNumber) {
        this.checklistLastActiveStep = stepNumber;
    }
    setChecklistData(checkListData) {
        this.checkListData = checkListData;
    }
    setIsChecklistResultView(isChecklistResultView) {
        this.isChecklistResultView = isChecklistResultView;
    }
    setShouldScrollToTopPageOnHomePage(shouldScrollToTopPageOnHomePage) {
...
let ContactBaseComponent = class ContactBaseComponent {
    ...
    ngOnInit() {
        setTimeout(() => {
            this.router.navigate([{ outlets: { contactOutlet: ['contact'] } }], { skipLocationChange: true });
        }, 100);
    }
};
ContactBaseComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
let ContactConfirmationComponent = class ContactConfirmationComponent {
    constructor(translate, translationLoader, validationsLoader) {
        this.translate = translate;
        this.translationLoader = translationLoader;
        this.validationsLoader = validationsLoader;
        this.translate.use('pl');
...
ContactConfirmationComponent.ctorParameters = () => [
    { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"] },
    { type: _app_modules_shared_module_services_i18n_translation_loader_service__WEBPACK_IMPORTED_MODULE_3__["TranslationLoaderService"] },
    { type: _app_modules_shared_module_services_i18n_validations_loader__WEBPACK_IMPORTED_MODULE_4__["ValidationLoader"] }
];
...
let ContactComponent = class ContactComponent {
    constructor(translate, translationLoader, validationsLoader, router, route, viewportScroller, contactService, storage, userService) {
        this.translate = translate;
        this.translationLoader = translationLoader;
        this.validationsLoader = validationsLoader;
        this.router = router;
    ...
    submit() {
        if (this.form.valid) {
            ...
            this.contactSubscription = this.contactService.saveLead(this.model)
                .subscribe((saveLeadResult) => {
                this.storage.set('leadId', saveLeadResult.id);
                this.router.navigate(['sendContactConfirmation'], { relativeTo: this.route, skipLocationChange: true });
                _app_modules_shared_module_components_loader_loader_component__WEBPACK_IMPORTED_MODULE_6__["LoaderComponent"].hide();
            }, (error) => {
                console.log(error);
                this.methodUnavailable = true;
            ...
            _app_modules_shared_module_components_loader_loader_component__WEBPACK_IMPORTED_MODULE_6__["LoaderComponent"].show().subscribe(() => {
                _app_modules_shared_module_components_loader_loader_component__WEBPACK_IMPORTED_MODULE_6__["LoaderComponent"].hide();
                this.methodUnavailable = true;
...
const contactOutlet = 'contactOutlet';
const routes = [
    {
        path: 'contact',
...
let ContactControlService = class ContactControlService {
    constructor(httpClient) {
        this.httpClient = httpClient;
    }
    prepareHeaders() {
    ...
    saveLead(contact, id) {
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].contact.isMock) {
            ...
            if (id) {
                return this.httpClient.put(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].contact.saveLead}/${id}`, { contact }, { headers });
            }
            else {
                return this.httpClient.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].contact.saveLead, { contact }, { headers });
            }
        }
    }
};
ContactControlService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let ContactService = class ContactService {
    constructor(contactControlService, storage) {
    ...
    saveLead(leadData) {
        ...
        const leadId = this.storage.get('leadId');
...
let LoginHomeComponent = class LoginHomeComponent {
    constructor(translate, translationLoader, validationsLoader, userService) {
        this.translate = translate;
        this.translationLoader = translationLoader;
        this.validationsLoader = validationsLoader;
        this.userService = userService;
    ...
    submit() {
        if (this.form.valid) {
            ...
            this.loginSubscription = this.userService.authenticateUser(this.model)
                .subscribe((authResposne) => {
                if (!authResposne.isAuthenticated) {
                    this.methodUnavailable = true;
                    this.errorMessage = this.incorrectAuthenticationTranslationKey;
                }
            ...
            this.loaderSubscription = _app_modules_shared_module_components_loader_loader_component__WEBPACK_IMPORTED_MODULE_5__["LoaderComponent"].show().subscribe(() => {
                _app_modules_shared_module_components_loader_loader_component__WEBPACK_IMPORTED_MODULE_5__["LoaderComponent"].hide();
                this.methodUnavailable = true;
                this.errorMessage = this.methodUnavailableTranslationKey;
...
LoginHomeComponent.ctorParameters = () => [
    { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__["TranslateService"] },
    { type: _app_modules_shared_module_services_i18n_translation_loader_service__WEBPACK_IMPORTED_MODULE_4__["TranslationLoaderService"] },
    { type: _app_modules_shared_module_services_i18n_validations_loader__WEBPACK_IMPORTED_MODULE_6__["ValidationLoader"] },
...
let LoaderComponent = LoaderComponent_1 = class LoaderComponent {
    constructor() {
        this.isVisible = () => LoaderComponent_1.visible;
    }
    static createTimer() {
...
LoaderComponent.hide = () => LoaderComponent_1.visible = false;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".app-accent-color {\n  color: #00965E;\n}\n\n.app-results {\n  text-align: center;\n  max-width: 450px;\n  position: relative;\n  margin: auto;\n}\n\n.app-results-zip {\n  position: relative;\n  margin: 0 auto;\n  width: auto;\n  height: auto;\n}\n\n.app-results-main-circle {\n  position: relative;\n  width: 70%;\n  background-color: #e6f3ee;\n  display: block;\n  padding-bottom: 70%;\n  margin: 0 auto;\n  height: auto;\n  font-size: inherit;\n  border-radius: 50%;\n  box-shadow: 0 2px 20px 1px rgba(0, 0, 0, 0.2);\n}\n\n.app-main-circle-content {\n  margin: 0;\n  position: absolute;\n  top: 40%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n}\n\n.app-results-loan-term-circle {\n  position: relative;\n  width: 40%;\n  display: block;\n  margin: 0 auto;\n  height: auto;\n  font-size: inherit;\n  border-radius: 50%;\n  margin-left: 3%;\n  margin-top: -20%;\n}\n\n.app-range-container-loan-term-circle {\n  max-width: 100%;\n  height: auto;\n}\n\n.app-results-circle {\n  position: relative;\n  width: 50%;\n  display: block;\n  margin: 0 auto;\n  height: auto;\n  font-size: inherit;\n  border-radius: 50%;\n  margin-right: 0;\n  margin-top: -45%;\n}\n\n.app-range-container {\n  max-width: 100%;\n  height: auto;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let SimulationResultsViewComponent = class SimulationResultsViewComponent {
    ...
    ngOnChanges(changes) {
        const changeSimulation = changes.simulation;
        const changeSimulationVariant = changes.simulationVariant;
        const changeSimulationParametres = changes.simulationParametres;
        this.trackSliderChagnes();
        if (this.resultCircleSlider) {
            this.updateResultViewAfterChange();
        }
    }
    updateResultViewAfterChange() {
    ...
    setUpInstalmentViewSlider() {
        const min = _assets_parameters_systemParameters__WEBPACK_IMPORTED_MODULE_3__["simulationParameters"].minInstallment;
        const max = _assets_parameters_systemParameters__WEBPACK_IMPORTED_MODULE_3__["simulationParameters"].maxInstallment;
        this.resultCircleSliderOptions = new _model__WEBPACK_IMPORTED_MODULE_6__["CircleSliderOption"]('resultCircle', '#00965E', min, max, 1, 195, (val, eventType) => {
            this.installmentValueChange((val < 0 ? 1 : val), eventType);
        });
        this.resultCircleSlider = new CircularSlider(this.cirleSliderId, this.resultCircleSliderOptions);
        this.resultCircleSlider.stepNo = this.simulation.installmentMonthlyAmount - _assets_parameters_systemParameters__WEBPACK_IMPORTED_MODULE_3__["simulationParameters"].minInstallment;
    }
    setUpLoanViewSlider() {
        const min = _assets_parameters_systemParameters__WEBPACK_IMPORTED_MODULE_3__["simulationParameters"].mintotalLoanAmount;
        const max = _assets_parameters_systemParameters__WEBPACK_IMPORTED_MODULE_3__["simulationParameters"].maxtotalLoanAmount;
        this.resultCircleSliderOptions = new _model__WEBPACK_IMPORTED_MODULE_6__["CircleSliderOption"]('resultCircle', '#00965E', min, max, 1, 195, (val, eventType) => {
            this.loanSliderValueChange((val < 0 ? 1 : val), eventType);
        });
        this.resultCircleSlider = new CircularSlider(this.cirleSliderId, this.resultCircleSliderOptions);
        this.resultCircleSlider.stepNo = this.simulation.loanAmount - _assets_parameters_systemParameters__WEBPACK_IMPORTED_MODULE_3__["simulationParameters"].mintotalLoanAmount;
    }
    initLoanTermCircleSlider() {
        const min = _assets_parameters_systemParameters__WEBPACK_IMPORTED_MODULE_3__["simulationParameters"].minLoanTermInYears;
        const max = _assets_parameters_systemParameters__WEBPACK_IMPORTED_MODULE_3__["simulationParameters"].maxLoanTermInYears;
        this.loanTermCircleSliderOptions = new _model__WEBPACK_IMPORTED_MODULE_6__["CircleSliderOption"]('loanTermCircle', '#00965E', min, max, 1, 195, (val, eventType) => {
            this.numberOfInstallmentsInYearsChange((val < 0 ? 1 : val), eventType);
        });
        this.loanTermCircleSlider = new CircularSlider(this.termCirleSliderId, this.loanTermCircleSliderOptions);
        this.loanTermCircleSlider.stepNo = this.simulation.numberOfInstallmentsInYears - _assets_parameters_systemParameters__WEBPACK_IMPORTED_MODULE_3__["simulationParameters"].minLoanTermInYears;
    }
    startTrackSlider(eventType) {
    ...
    trackSliderChagnes() {
        ...
        this.sliderChangeEvent
            ...
            .subscribe((data) => { this.startRecalculation(data); }, (err) => console.error(err));
    }
    startRecalculation(newValue) {
        if (newValue) {
            this.recalculate(this.simulationParametres);
            this.sliderChangeEvent.next('');
        }
    }
    installmentValueChange(val, eventType) {
    ...
    loanSliderValueChange(val, eventType) {
        this.sliderValueResultCircle = val;
    ...
    numberOfInstallmentsInYearsChange(val, eventType) {
    ...
    recalculate(model) {
        this.simulationSubscribtion = this.simulationService.recaluculate(model)
            ...
            this.simulationService.saveResults(result);
        }, (error) => {
            console.log(error);
            this.apiMethodUnavailable = true;
        });
...
SimulationResultsViewComponent.ctorParameters = () => [
...
let ViewDataContainerComponent = class ViewDataContainerComponent {
    constructor() { }
};
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
...
class AppViewData {
    constructor(label = '', data = null, id = '') {
        this.label = label;
        this.data = data;
        this.id = id;
    }
...
class CircleSliderOption {
    constructor(container = '', color = '', min = 0, max = 0, step = 0, radius = 0, valueChange) {
...
let InstalmentSufix = class InstalmentSufix {
...
InstalmentSufix.ctorParameters = () => [
    { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"] }
];
...
let ValidationLoader = ValidationLoader_1 = class ValidationLoader {
    constructor(translate, formlyConfig, spacePipe) {
        this.translate = translate;
        this.formlyConfig = formlyConfig;
        this.spacePipe = spacePipe;
    }
    static phoneAllowed(testedValue) {
        return /^\d{9}$/i.test(testedValue);
    }
    static phoneNotAllowed(testedValue) {
        ...
        for (let i = 0; i < negativeRegexps.length; i++) {
    ...
    init() {
        ...
        this.formlyConfig.addValidatorMessage('phone', (err, field) => this.translate.instant('Validations.phone'));
        this.formlyConfig.addValidatorMessage('firstName', (err, field) => this.translate.instant('Validations.firstName'));
        this.formlyConfig.addValidatorMessage('lastName', (err, field) => this.translate.instant('Validations.lastName'));
        // message with params
...
ValidationLoader.ctorParameters = () => [
    { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"] },
...
let UserAuthService = class UserAuthService {
    constructor(userControlService, storage) {
    ...
    setupUserSession() {
        const savedLastLogin = this.getLoginDateFromLocalStorage();
    ...
    isTimeOfLastLoginShorterThanSessionParam(lastLogin) {
    ...
    getTimeInMilis(timeInMinutes) {
        return timeInMinutes * 1000 * 60;
    }
    getTimeDiffInMilisFromNow(diffDate) {
        return (new Date().getTime() - new Date(diffDate).getTime());
    }
    getTimeToCloseSessionInMilis() {
        const lastLogin = this.getLoginDateFromLocalStorage();
    ...
    authenticateUser(loginRequest) {
        return this.userControlService.authenticateUser(loginRequest).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(loginResponse => {
    ...
    setLoginDateToLocalStorage() {
        this.storage.set('loginDate', new Date());
    }
    getLoginDateFromLocalStorage() {
        const savedLoginDate = this.storage.get('loginDate');
        if (savedLoginDate) {
...
let UserControlService = class UserControlService {
    ...
    authenticateUser(loginRequest) {
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].user.isMock) {
            ...
            return this.httpClient.post(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].user.authenticationUrl, loginRequest, { headers });
        }
    }
};
...
let CheckboxWithTooltipOnClickComponent = class CheckboxWithTooltipOnClickComponent extends _ngx_formly_core__WEBPACK_IMPORTED_MODULE_2__["FieldType"] {
    constructor() {
        super(...arguments);
...
let CheckboxWithTooltipComponent = class CheckboxWithTooltipComponent extends _ngx_formly_core__WEBPACK_IMPORTED_MODULE_2__["FieldType"] {
};
...
let CustomInputComponent = class CustomInputComponent extends _ngx_formly_core__WEBPACK_IMPORTED_MODULE_2__["FieldType"] {
};
...
let CustomRadioComponent = class CustomRadioComponent extends _ngx_formly_core__WEBPACK_IMPORTED_MODULE_2__["FieldType"] {
    optionSelected(scrollBy) {
...
let DigitInputComponent = class DigitInputComponent extends _ngx_formly_core__WEBPACK_IMPORTED_MODULE_2__["FieldType"] {
};
...
let RepeatSectionComponent = class RepeatSectionComponent extends _ngx_formly_core__WEBPACK_IMPORTED_MODULE_2__["FieldArrayType"] {
};
...
let HorizontalWrapperComponent = class HorizontalWrapperComponent extends _ngx_formly_core__WEBPACK_IMPORTED_MODULE_2__["FieldWrapper"] {
};
...
let SectionInfoComponent = class SectionInfoComponent extends _ngx_formly_core__WEBPACK_IMPORTED_MODULE_2__["FieldWrapper"] {
};
...
let VerticalWrapperComponent = class VerticalWrapperComponent extends _ngx_formly_core__WEBPACK_IMPORTED_MODULE_2__["FieldWrapper"] {
};
...
let SimulationBaseComponent = class SimulationBaseComponent {
    constructor(router, eltRef, interComponentCommunicationService, userService) {
        this.router = router;
        this.eltRef = eltRef;
        this.interComponentCommunicationService = interComponentCommunicationService;
    ...
    ngOnInit() {
        ...
        const showChecklistBtn = this.eltRef.nativeElement.hasAttribute('checklistAnchor');
        if (showChecklistBtn) {
            const checklistAnchor = this.eltRef.nativeElement.getAttribute('checklistAnchor');
...
SimulationBaseComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"] },
...
let SimulationFormModalComponent = class SimulationFormModalComponent {
    constructor(bsModalRef, simulationService) {
    ...
    recalculate() {
        this.simulationService.getSimulationResults$(this.model).subscribe((result) => {
            _app_modules_shared_module_components_loader_loader_component__WEBPACK_IMPORTED_MODULE_4__["LoaderComponent"].hide();
            this.simulationService.saveResults(result);
        });
    }
};
SimulationFormModalComponent.ctorParameters = () => [
...
let SimulationHomeComponent = class SimulationHomeComponent {
    constructor(translate, translationLoader, interComponentCommunicationService) {
        this.translate = translate;
        this.translationLoader = translationLoader;
        this.interComponentCommunicationService = interComponentCommunicationService;
...
SimulationHomeComponent.ctorParameters = () => [
    { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"] },
    { type: _app_modules_shared_module_services_i18n_translation_loader_service__WEBPACK_IMPORTED_MODULE_3__["TranslationLoaderService"] },
...
let SimulationPathComponent = class SimulationPathComponent {
    constructor(translate, translationLoader, validationsLoader, route, simulationService, viewportScroller, interComponentCommunicationService, spacePipe) {
        this.translate = translate;
        this.translationLoader = translationLoader;
        this.validationsLoader = validationsLoader;
        this.route = route;
    ...
    ngOnInit() {
        this.viewportScrollAnchor = this.interComponentCommunicationService.viewportScrollAnchor;
        this.routeSubscription = this.route.url.subscribe(path => {
            const simulationPath = path[1].path;
            let stepOneFields;
            switch (simulationPath) {
                case 'installment':
                    stepOneFields = this.simulation.formFieldInstallmentStepOne();
                    this.onInit(stepOneFields);
                    break;
                case 'loan-amount':
                    stepOneFields = this.simulation.formFieldLoanStepOne();
                    this.onInit(stepOneFields);
                    break;
                default:
    ...
    onInit(stepOneFields) {
        ...
        this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormArray"](this.formSteps.map(() => new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormGroup"]({})));
    }
    prevStep(step) {
        this.activeStep = step - 1;
        this.returnToTopPagePosition();
    ...
    submit(step) {
        if (this.form.valid) {
            this.simulationSubscribtion = this.simulationService.getSimulationResults$(this.model).subscribe((result) => {
                _app_modules_shared_module_components_loader_loader_component__WEBPACK_IMPORTED_MODULE_9__["LoaderComponent"].hide();
                this.methodUnavailable = false;
                this.simulationService.saveResults(result);
                this.activeStep = step + 1;
                this.isResultView = true;
                this.interComponentCommunicationService.simulationLastActiveStep = this.activeStep;
            }, (error) => {
                console.log(error);
                this.methodUnavailable = true;
                _app_modules_shared_module_components_loader_loader_component__WEBPACK_IMPORTED_MODULE_9__["LoaderComponent"].hide();
            });
            _app_modules_shared_module_components_loader_loader_component__WEBPACK_IMPORTED_MODULE_9__["LoaderComponent"].show().subscribe(() => {
                this.closeSimulationSubscriptionIfTooLongNotRespond();
            });
        }
    }
    closeSimulationSubscriptionIfTooLongNotRespond() {
        _app_modules_shared_module_components_loader_loader_component__WEBPACK_IMPORTED_MODULE_9__["LoaderComponent"].hide();
        this.methodUnavailable = true;
    ...
    returnToTopPagePosition() {
        this.viewportScroller.scrollToAnchor(this.viewportScrollAnchor);
    }
};
SimulationPathComponent.ctorParameters = () => [
    { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"] },
...
let SimulationResultsComponent = class SimulationResultsComponent {
    constructor(translate, translationLoader, simulationService, router, route, spacePipe, viewportScroller, interComponentCommunicationService, modalService) {
        this.translate = translate;
        this.translationLoader = translationLoader;
        this.simulationService = simulationService;
        this.router = router;
    ...
    ngOnInit() {
        ...
        this.viewportScrollAnchor = this.interComponentCommunicationService.viewportScrollAnchor;
        this.simulationService.currentSimulationParameters.subscribe(data => {
            this.simulationParametres = data;
            this.parametersToChange =
                new _model_SimulationResultsCalc__WEBPACK_IMPORTED_MODULE_7__["SimulationResultsCalc"](this.simulationService, this.simulationParametres, this.translate, this.spacePipe);
            if (this.simulationParametres.installmentMonthlyAmount) {
                this.fields =
                    this.parametersToChange.formFieldInstallment();
            }
            if (this.simulationParametres.totalLoanAmount) {
                this.fields = this.parametersToChange.formFieldLoan();
            }
        });
        this.simulationService.currentSimulationResult.subscribe(data => {
            this.simulationResults = data.simulations;
            this.optimalOption = false;
            this.quickOption = false;
            this.safeOption = false;
            this.activeResultArr = [];
            this.setUpResults();
        });
    }
    ...
    setUpResults() {
        ...
        if (this.simulationResults.find(result => result.simulationVariant === this.optimalVariantName)) {
            this.optimalOption = true;
            this.simulationSetUp(this.optimalVariantName);
        }
        if (this.simulationResults.find(result => result.simulationVariant === this.quickVariantName)) {
            this.quickOption = true;
            this.simulationSetUp(this.quickVariantName);
        }
        if (this.simulationResults.find(result => result.simulationVariant === this.safeVariantName)) {
    ...
    simulationSetUp(variant) {
        this.activeResultArr.push(variant);
        this.simulation = this.simulationResults.find(result => result.simulationVariant === variant);
    }
    setUpView() {
        this.simulation = this.simulationResults.find(result => result.simulationVariant === this.activeResult);
        ...
        const interestRate = this.simulation.interestRate * 100;
    ...
    goLeft() {
        const currentActiveOption = this.activeResultArr.indexOf(this.activeResult);
    ...
    openModal() {
        ...
        this.mobileForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormArray"](this.mobileFormSteps.map(() => new _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormGroup"]({})));
        const initialState = {
            model: this.model,
            fields: this.fields,
        ...
        this.bsModalRef = this.modalService.show(_simulation_form_modal_simulation_form_modal_component__WEBPACK_IMPORTED_MODULE_12__["SimulationFormModalComponent"], Object.assign({ initialState }, { class: 'app-modal-full-screen' }));
    }
};
SimulationResultsComponent.ctorParameters = () => [
    { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"] },
    { type: _app_modules_shared_module_services_i18n_translation_loader_service__WEBPACK_IMPORTED_MODULE_4__["TranslationLoaderService"] },
    { type: _app_modules_simulation_service_simulation_service__WEBPACK_IMPORTED_MODULE_3__["SimulationService"] },
...
let SimulationSendComponent = class SimulationSendComponent {
    constructor(translate, translationLoader, validationsLoader, simulationService, router, route, storage, viewportScroller, interComponentCommunicationService, userService) {
        this.translate = translate;
        this.translationLoader = translationLoader;
        this.validationsLoader = validationsLoader;
        this.simulationService = simulationService;
    ...
    saveLeadAndSimulationAndSendEmail() {
        this.simulationService.saveLead(this.model).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["flatMap"])(saveLeadResult => {
            this.storage.set('leadId', saveLeadResult.id);
            return this.simulationService.saveSimulationResult$(saveLeadResult.id);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["flatMap"])(saveSimulationResult => {
            return this.simulationService.sendSimulation$(this.model.email);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["flatMap"])(result => {
            this.router.navigate(['../sendSimulationSuccess'], { relativeTo: this.route, skipLocationChange: true });
    ...
    sendEmail() {
        this.simulationService.sendSimulation$(this.model.email).subscribe(value => {
            this.router.navigate(['../sendSimulationSuccess'], { relativeTo: this.route, skipLocationChange: true });
            _app_modules_shared_module_components_loader_loader_component__WEBPACK_IMPORTED_MODULE_7__["LoaderComponent"].hide();
        }, err => {
            console.log(err);
...
SimulationSendComponent.ctorParameters = () => [
    { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"] },
    { type: _app_modules_shared_module_services_i18n_translation_loader_service__WEBPACK_IMPORTED_MODULE_3__["TranslationLoaderService"] },
    { type: _app_modules_shared_module_services_i18n_validations_loader__WEBPACK_IMPORTED_MODULE_5__["ValidationLoader"] },
...
let SimulationSentComponent = class SimulationSentComponent {
    constructor(translate, translationLoader, validationsLoader, viewportScroller, router, route, interComponentCommunicationService) {
        this.translate = translate;
        this.translationLoader = translationLoader;
        this.validationsLoader = validationsLoader;
        this.viewportScroller = viewportScroller;
...
SimulationSentComponent.ctorParameters = () => [
    { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"] },
    { type: _app_modules_shared_module_services_i18n_translation_loader_service__WEBPACK_IMPORTED_MODULE_3__["TranslationLoaderService"] },
    { type: _app_modules_shared_module_services_i18n_validations_loader__WEBPACK_IMPORTED_MODULE_4__["ValidationLoader"] },
    { type: _angular_common__WEBPACK_IMPORTED_MODULE_5__["ViewportScroller"] },
...
class Simulation {
    constructor(translations, spacePipe) {
        this.translations = translations;
        this.spacePipe = spacePipe;
    }
    formFieldInstallmentStepOne() {
        return [
            {
                fieldGroup: [
    ...
    formFiledInstallmentMonthlyAmount() {
        return {
            className: 'col-12 app-justify-content-center app-form-field',
            type: 'digit-input',
            wrappers: ['form-field-horizontal'],
    ...
    formFiledExpectedContributionAmount() {
        return {
            className: 'col-12 app-justify-content-center app-form-field',
            type: 'digit-input',
            wrappers: ['form-field-horizontal'],
    ...
    formFiledTotalCostOfLiabilitiesLoan() {
        return {
            className: 'col-12 app-justify-content-center app-form-field',
            type: 'digit-input',
            wrappers: ['form-field-horizontal'],
    ...
    formFiledTotalCostOfLiabilitiesCreditCards() {
        return {
            className: 'col-12 app-justify-content-center app-form-field',
            type: 'digit-input',
            wrappers: ['form-field-horizontal'],
...
class SimulationResultsCalc {
    constructor(simulationService, simulationParametres, translations, spacePipe) {
        this.simulationService = simulationService;
    ...
    mobileFormFieldInstallmentStepOne(calculateOnChange) {
    ...
    mobileFormFieldLoanStepOne(calculateOnChange) {
        this.calculateOnChange = calculateOnChange;
        return [
            {
                fieldGroup: [
    ...
    formFiledInstallmentMonthlyAmount() {
        return {
            ...
            templateOptions: {
                ...
                min: _assets_parameters_systemParameters__WEBPACK_IMPORTED_MODULE_1__["simulationParameters"].minInstallment,
                max: _assets_parameters_systemParameters__WEBPACK_IMPORTED_MODULE_1__["simulationParameters"].maxInstallment,
                change: (field, $event) => { this.recalculateOnChange(field); },
            }
        };
    }
    formFiledTotalLoanAmount() {
    ...
    recalculateOnChange(field) {
        if (this.calculateOnChange === true) {
            clearTimeout(this.waitingForResults);
            if (field.formControl.status === 'VALID') {
                this.waitingForResults = setTimeout(() => this.recalculate(field.key, field.formControl.value), _env_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].recalculationTimeoutInMillis);
            }
        }
    }
    recalculate(field, value) {
        const model = this.simulationParametres;
    ...
    submit(model) {
        this.simulationSubscribtion = this.simulationService.recaluculate(model).subscribe((result) => {
        ...
        _app_modules_shared_module_components_loader_loader_component__WEBPACK_IMPORTED_MODULE_2__["LoaderComponent"].show().subscribe(() => {
            this.closeSimulationSubscriptionIfTooLongNotRespond();
        });
    }
    closeSimulationSubscriptionIfTooLongNotRespond() {
...
let InterComponentCommunicationService = class InterComponentCommunicationService {
    ...
    showChecklistBtn(checklistAnchor) {
...
let SimulationControlService = class SimulationControlService {
    constructor(httpClient) {
        this.httpClient = httpClient;
    }
    prepareHeaders() {
    ...
    getSimulationResultsByInstallment$(simpleSimulationRequest) {
        const headers = this.prepareHeaders();
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].simulatorUrl.isMock) {
            ...
            return this.httpClient.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].simulatorUrl.installment, simpleSimulationRequest, { headers });
        }
    }
    getSimulationResultsByLoan$(simpleSimulationRequest) {
        const headers = this.prepareHeaders();
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].simulatorUrl.isMock) {
            return this.httpClient.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].simulatorUrl.loan);
        }
        else {
            return this.httpClient.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].simulatorUrl.loan, simpleSimulationRequest, { headers });
        }
    }
    saveSimulation(result) {
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].simulatorUrl.isMock) {
            ...
            return this.httpClient.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].simulatorUrl.save, result, { headers });
        }
    }
    sendMailByInstallment$(simulationResultsWithEmailBody) {
        const headers = this.prepareHeaders();
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].checklist.isMock) {
            ...
            return this.httpClient.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].simulation.emailUrl.installment, simulationResultsWithEmailBody, { headers });
        }
    }
    sendMailByByLoan$(simulationResultsWithEmailBody) {
        const headers = this.prepareHeaders();
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].checklist.isMock) {
            return this.httpClient.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].simulation.emailUrl.loan);
        }
        else {
            return this.httpClient.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].simulation.emailUrl.loan, simulationResultsWithEmailBody, { headers });
        }
    }
};
SimulationControlService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let SimulationService = class SimulationService {
    constructor(simulationControlService, storage, contactService, translate, translationLoader) {
        ...
        this.translate.use('pl');
        this.translationLoader.loadTranslations();
        this.currentSimulationResult.subscribe(data => this.simulationResultsToSend = data);
        this.currentSimulationParameters.subscribe(data => this.simulationParametersToShare = data);
    }
    recaluculate(simulationParameters) {
    ...
    getSimulationResults$(simulationInput) {
        const simulationParameters = this.mapSimulationInputToDataToSend(simulationInput);
        this.simulationParameters.next(simulationParameters);
    ...
    saveResults(currentSimulationResult) {
        this.simulationResult.next(currentSimulationResult);
    }
    saveSimulationResult$(leadId) {
        if (this.simulationParametersToShare.installmentMonthlyAmount) {
    ...
    mapSimulationInputToDataToSend(simulationInput) {
        const simpleSimulationRequestToSend = {
    ...
    sendSimulation$(recipient) {
        const interestRate = this.simulationResultsToSend.simulations[0].interestRate; // Każda symulacja ma ten sam.
        const simulationResponses = [];
        let translatedVariantName;
        this.simulationResultsToSend.simulations.forEach((simulation => {
            this.translate.get('SimulatorResults.switch').subscribe(translated => {
        ...
        const simulationsToSend = this.createSimulationResultsWithEmailBody(interestRate, simulationResponses, recipient);
        if (this.simulationParametersToShare.installmentMonthlyAmount) {
    ...
    createSendSimpleSimulationByMailRequest(simpleSimulationWithAdditionalParameters) {
        if (this.simulationParametersToShare.installmentMonthlyAmount) {
            return {
                simpleSimulationWithAdditionalParameters,
    ...
    createSimulationResultsWithEmailBody(interestRate, simulationResponses, recipient) {
        const simpleSimulationWithAdditionalParameters = {
            simpleSimulationRequest: this.simulationParametersToShare.simpleSimulationRequest,
            interestRate
        };
        const simpleSimulationToSentByMailRequest = this.createSendSimpleSimulationByMailRequest(simpleSimulationWithAdditionalParameters);
        const result = {
            simulationResponses,
...
const simulationOutlet = 'simulationOutlet';
const routes = [
    {
        path: 'simulation',
...
let SimulationRoutingModule = class SimulationRoutingModule {
};
...
const API_URL = 'https://simulator-zzsh7nvnra-ew.a.run.app';
const environment = {
    production: false,
    contact: {
        isMock: true,
